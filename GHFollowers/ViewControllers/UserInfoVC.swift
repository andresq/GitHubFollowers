...
//  GHFollowers
//
//  Created by Andres Quintero on 9/14/20.
...
class UserInfoVC: UIViewController {
    ...
    let dateLabel = GFBodyLabel(textAligment: .center) // Seems to not work?
    ...
    func configureViewController() {
        ...
        let doneBotton = UIBarButtonItem(barButtonSystemItem: .done, target: self, action: #selector(dismissVC))
        navigationItem.rightBarButtonItem = doneBotton
    }
    ...
    func layoutUI() {
        ...
        dateLabel.textAlignment = .center // needed because the init() doesnt seem to work
